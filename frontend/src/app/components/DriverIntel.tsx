...
function StatCard({ label, value, unit, precision = 2, accent }: {
  ...
  return (
    <div className={`rounded-lg p-3 transition-colors ${accent ? 'bg-[#FF8000]/5 border border-[#FF8000]/20' : 'bg-[#0D1117] border border-[rgba(255,128,0,0.06)]'}`}>
...
function CustomTooltip({ active, payload }: any) {
  ...
  return (
    <div className="bg-[#0D1117]/95 backdrop-blur-sm border border-[rgba(255,128,0,0.15)] rounded-lg px-3 py-2 shadow-lg">
      {payload.map((p: any) => (
    ...
    <button
      ...
      className={`px-2.5 py-1 rounded-md text-[11px] font-medium transition-colors ${
        sortBy === key
          ...
          : 'text-muted-foreground hover:text-foreground border border-transparent hover:border-[rgba(255,128,0,0.08)]'
      }`}
    >
  ...
  return (
    <div className="space-y-4">
      ...
      {anomalyVehicles.length > 0 && (
        <div className="flex items-center gap-4 px-4 py-2.5 bg-[#0D1117] rounded-xl border border-[rgba(255,128,0,0.08)] text-[12px]">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm bg-[#0D1117] border border-[rgba(255,128,0,0.10)] rounded-lg text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-[#FF8000]/30 transition-colors"
          />
        </div>
...
function PerformanceProfile({ driverCode, onSelect, anomalyVehicles, onCompare, onBack }: {
  ...
  return (
    <div className="space-y-5">
      {/* ── Hero Header ── */}
      <div className="relative bg-[#1A1F2E] border border-[rgba(255,128,0,0.10)] rounded-xl overflow-hidden">
        ...
        <div className="relative px-5 py-4 flex items-center gap-4">
          {onBack && (
            <button type="button" aria-label="Back to driver grid" onClick={onBack} className="w-8 h-8 rounded-lg bg-[#0D1117]/60 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-[#0D1117] transition-colors">
          ...
          <select
            ...
            className="bg-[#0D1117] border border-[rgba(255,128,0,0.10)] rounded-lg px-3 py-2 text-[12px] text-foreground focus:outline-none focus:border-[#FF8000]/30 transition-colors cursor-pointer"
          >
            {drivers.map((d: any) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="space-y-2">
                {['SOFT', 'MEDIUM', 'HARD', 'INTERMEDIATE', 'WET']
                  ...
                  .map((c: any) => {
                    ...
                    return (
                      <div key={c.compound} className="bg-[#0D1117] rounded-lg p-3 border border-[rgba(255,128,0,0.04)]">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <div className="h-1 bg-[#222838] rounded-full mt-1.5 overflow-hidden">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          {onCompare && (
            <button
              onClick={onCompare}
              className="w-full bg-[#1A1F2E] border border-dashed border-[rgba(255,128,0,0.20)] rounded-xl p-3.5 flex items-center justify-center gap-3 hover:border-[#FF8000]/40 hover:bg-[#FF8000]/[0.03] transition-all group"
            >
          ...
          {selectedVehicle && (
            <>
              ...
              <div className="grid grid-cols-12 gap-3">
                {/* Overall gauge */}
                <div className="col-span-3 bg-[#1A1F2E] border border-[rgba(255,128,0,0.08)] rounded-xl p-4 flex flex-col items-center justify-center gap-2">
                ...
                <div className="col-span-9 grid grid-cols-3 gap-2.5">
                  {selectedVehicle.systems.map((sys) => {
                    ...
                    return (
                      <div key={sys.name} className="bg-[#1A1F2E] border border-[rgba(255,128,0,0.08)] rounded-xl p-3">
                        ...
                        <div className="w-full h-1 bg-[#222838] rounded-full overflow-hidden mb-2.5">
        ...
        <div className="w-[190px] shrink-0 space-y-2">
          <div className="relative">
            ...
            <input
              ...
              onChange={e => setSearch(e.target.value)}
              placeholder="Search\u2026"
              className="w-full bg-[#0D1117] border border-[rgba(255,128,0,0.08)] rounded-lg pl-8 pr-3 py-1.5 text-[12px] text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-[#FF8000]/25 transition-colors"
            />
          </div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-left text-[11px] transition-all ${
                    isSelected
                      ? 'bg-[rgba(255,128,0,0.06)] border border-[rgba(255,128,0,0.12)]'
                      : 'hover:bg-[#1A1F2E] disabled:opacity-25 border border-transparent'
                  }`}
                >
                  {isSelected ? (
