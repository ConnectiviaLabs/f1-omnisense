...
// View types
export type ViewType = 'home' | 'dashboard' | 'car' | 'driver' | 'schedule' | 'prime-driver' | 'prime-car' | 'prime-team' | 'prime-strategy' | 'advantage-trident' | 'advantage-crossover' | 'ai-insights' | 'regulations' | 'media' | 'radio' | 'chat';
