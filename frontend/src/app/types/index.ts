...
// View types
export type ViewType = 'dashboard' | 'mclaren-analytics' | 'car' | 'driver' | 'ai-insights' | 'regulations' | 'media' | 'chat' | 'fleet-overview' | 'driver-intel' | 'circuit-intel' | 'race-strategy' | 'anomaly-detection' | 'forecasting';
